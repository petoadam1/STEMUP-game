...
generate_img = pygame.image.load('img/Icons/generate.png').convert_alpha()
...
def delete_map_infos():
    ...
    db.commit()
    mycursor.execute("DELETE FROM floor_row_size")
    db.commit()
...
generate_button = button.Button(screen, screen_width / 2 - 40, screen_height / 2 + 80, generate_img, 80, 20)
